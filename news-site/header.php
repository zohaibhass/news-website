...
if (mysqli_num_rows($result) > 0) {
  while ($row = mysqli_fetch_assoc($result)) {
    ...
    if ($row['logo']=="") {
        ...
        echo '<a href="index.php" id="logo"><img src="admin/'.$row['logo'].'"></a>';
...
<div id="menu-bar">
    <div class="container">
        <div class="row">
            ...
            $sql="SELECT category_id, category_name  FROM category WHERE category_id =(select category from post where category= category_id limit 1) ";
            $result= mysqli_query($conn,$sql);

            // echo "<pre style=''>"; print_r($result); exit;
            if(mysqli_num_rows($result) > 0){
